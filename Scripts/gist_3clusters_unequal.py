...
folder_path = os.path.join(os.path.expanduser("~"), "Desktop", "gist_clusters_unequal_points_03092024")
...
for num_points_per_cluster in num_points_per_cluster_list:
    ...
    title = f'plot_{sum(num_points_per_cluster)}_{num_clusters}_clusters_dist_3.png'
